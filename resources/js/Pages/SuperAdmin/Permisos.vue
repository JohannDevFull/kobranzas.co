              ...
              <div class="col-sm-4" style="border:black 2px solid">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <div class="list-group" style="padding: 10px;">
                    <tr v-for="row in data"   class="hover:bg-gray-100 focus-within:bg-gray-100">
                      
                      <td class="border-t"> 
                        <inertia-link class="list-group-item list-group-item-action" style="width: 180px" :href="route('rol.permisos')">
                           {{ row.name }} 
                        </inertia-link>
                      </td>
